...
i_noise=135
lam_ftir=D_ftir(i_noise:end,1);%wavenumber
Data_ftir=D_ftir(i_noise:end,2:end); %intensity

% figure();plot(lam_ftir_20MeOH,D_ftir_20MeOH)
% solvent data
...
LOF_F=[];CF_F=[];
N_R= 6%input('Enter Number of Parafac to run ');
