...
WO_solv_substraction(Z_ftir, P_ftir, R_f,Data_name,lam_ftir,D_ftir_solvent,dir_save,lb,opts)
...
function WO_solv_substraction(Z_ftir, P_ftir, R_f,Data_name,lam_ftir,D_ftir_solvent,dir_save,lb,opts)
    global N_I
    ...
    print(strcat(dir_save,strrep(Data_name,'.mat',''),'_WO_SolvExt_PCs.png'),'-dpng','-r300')
    ...
    file_name = strcat(dir_save,'WO_SolvExt_',strrep(Data_name,'.mat',''),'.csv');
